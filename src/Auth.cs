...
namespace TLImporter
{
    class Auth
    {
        ...
        static string phoneError = "Error. Phone you entered is not in the valid format. Please, try again: ";
        ...
        internal static TelegramClient Client1()
        {
            ...
            return new TelegramClient(ImporterApp.apiId, ImporterApp.apiHash, store1, "sessionUser1");
        }
        internal static TelegramClient Client2()
        {
            var store2 = new FileSessionStore();
            return new TelegramClient(ImporterApp.apiId, ImporterApp.apiHash, store2, "sessionUser2");
        }
        internal static async Task AuthUser1()
        {
            ...
            string password1;
            var client1 = Client1();
            Console.Write("\n\nPlease, type the User 1 phone number with the prefixed code. Example: +34666777888. Press ENTER afterwards: ");
        ...
        internal static async Task AuthUser2()
        {
            ...
            string password2;
            var client2 = Client2();
            Console.Write("\n\nPlease, type the User 2 phone number with the prefixed code. Example: +34666777888. Press ENTER afterwards: ");
